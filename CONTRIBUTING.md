...
本项目使用 [AGPL-3.0](LICENSE) 许可证。当你向本项目提交 Pull Request 时，即表示你同意：

1. **你的贡献按 AGPL-3.0 许可证授权**（Inbound=Outbound）——你提交的代码将以与项目相同的许可证分发，无需额外签署 CLA。
2. **你拥有提交该贡献的权利**——代码是你原创的，或你已获得必要的授权。
3. **你理解贡献是公开且永久的**——一旦合并，你的贡献将作为项目的一部分公开分发。

如果你的贡献包含第三方代码，请确保其许可证与 AGPL-3.0 兼容，并在 PR 中说明来源和许可信息。
